...
export const FIRST_CONTENT = {
  ...
  lessons: [
    ...
    },
    {
      ...
      content:
        "Cada venta reparte según tu plan: 93% para ti y 7% de plataforma (pago cuando vendes), o 100% para ti con el plan mensual de $25. Los retiros se procesan desde tu monedero.",
      isFreePreview: false,
      useHeroVideo: false,
    },
  ],
