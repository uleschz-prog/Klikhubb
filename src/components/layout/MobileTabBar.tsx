...
export function MobileTabBar() {
  ...
  return (
    ...
    >
      {/* Un solo safe-area: evita barra doble en Huawei Browser / PWA */}
        ...
        {tabs.map((tab) => {
          ...
          return (
            <li key={tab.href}>
              <Link
                href={tab.href}
                className={`flex h-full min-h-14 flex-col items-center justify-center text-[10px] font-semibold uppercase tracking-wider ${
