      ...
      <section className="relative isolate min-h-[100svh] overflow-hidden">
        ...
        <div className="relative z-10 mx-auto flex min-h-[100svh] max-w-6xl flex-col justify-end px-4 pb-16 pt-28 md:justify-center md:pb-24 md:pt-24">
          <motion.p
            ...
            className="font-display text-[clamp(3.4rem,12vw,7.5rem)] font-extrabold leading-[0.9] tracking-tight"
          >
          ...
          <motion.h1
            ...
            className="mt-5 max-w-xl font-display text-[1.85rem] font-extrabold leading-[1.08] tracking-tight text-balance sm:text-4xl md:text-5xl"
          >
            Del video al pago.
          ...
          <motion.p
            ...
            className="mt-4 max-w-md text-base leading-7 text-white/65 sm:text-lg"
          >
